...
function App() 
{
    ...
    return (
        <div id='appContainer'>
            <Header soyCero={soyCero} setSoyCero={setSoyCero}/>
            <h1>REACT</h1>
            <Players player_data={player_data} pm_pos={props.pm_pos} players={all_players}/>
            <LawsLayout skipped_turns={stats_turno.skipped_turns} cant_descart={props.cant_descart} cant_left={stats_turno.cant_left} blue={stats_turno.blue} red={stats_turno.red}/>
